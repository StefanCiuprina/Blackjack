...
var $author$project$Main$calculateScore = function (cards) {
	var calculateScoreHelper = F3(
		function (cardsList, score, numberOfAces) {
			calculateScoreHelper:
			while (true) {
				if (cardsList.b) {
					var x = cardsList.a;
					var xs = cardsList.b;
					var _v1 = $author$project$Card$cardValue(x);
					if (!_v1.b) {
						return -1;
					} else {
						var y = _v1.a;
						var ys = _v1.b;
						if (_Utils_eq(ys, _List_Nil)) {
							var $temp$cardsList = xs,
								$temp$score = score + y,
								$temp$numberOfAces = numberOfAces;
							cardsList = $temp$cardsList;
							score = $temp$score;
							numberOfAces = $temp$numberOfAces;
							continue calculateScoreHelper;
						} else {
							var $temp$cardsList = xs,
								$temp$score = score,
								$temp$numberOfAces = numberOfAces + 1;
							cardsList = $temp$cardsList;
							score = $temp$score;
							numberOfAces = $temp$numberOfAces;
							continue calculateScoreHelper;
					...
					if (!numberOfAces) {
						...
						if ((_Utils_cmp((21 - score) - 1, (21 - score) - 11) < 0) || ((score + 11) > 21)) {
							var $temp$cardsList = _List_Nil,
								$temp$score = score + 1,
								$temp$numberOfAces = numberOfAces - 1;
							cardsList = $temp$cardsList;
							score = $temp$score;
	...
	return A3(calculateScoreHelper, cards, 0, 0);
};
...
var $author$project$Test$Generated$Main3566543358$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		globs: _List_Nil,
		paths: _List_fromArray(
			['/home/stefan/UTCN/An3Sem1/FP/assignments/project/BlackJack/tests/Tests.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 295358254631052
	},
...
_Platform_export({'Test':{'Generated':{'Main3566543358':{'init':$author$project$Test$Generated$Main3566543358$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-3694.sock";
